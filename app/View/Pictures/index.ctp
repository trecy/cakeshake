<div class="pictures index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('legende'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($picture['Picture']['legende']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($picture['User']['id'], array('controller' => 'users', 'action' => 'view', $picture['User']['id'])); ?>
		</td>
		<td class="actions">
